...
<ul>
  ...
  <li><a href="https://www.whatismybrowser.com/">WhatIsMyBrowser</a></li>
...
<table>
  ...
  <ul>
    <li><a href="https://www.openstreetmap.org/">OpenStreetMap</a></li>
     <p>Enquanto o OSM em si é uma base de dados aberta e não um serviço de mapas privado, diversas aplicações baseadas no OSM priorizam a privacidade dos usuários..</p>
    <li><a href="https://maps.me/">Maps.me</a></li>
     <p>App de mapeamento offline que utiliza o OpenStreetMap e permite navegar sem uma conexão à internet, reduzindo o rastreamento online.</p>
    <li><a href="https://www.mapillary.com/mobile-apps?locale=pt_PT">Mapillary</a></li>
     <p>Uma alternativa ao Google Street View, o Mapillary é uma plataforma de imagens colaborativas que permite explorar locais sem rastreamento..</p>
    <li><a href="https://marble.kde.org/">Marble</a></li>
     <p>Um globo virtual e atlas mundial que permite ao usuário explorar diferentes locais sem compartilhar informações pessoais.</p>
    <li><a href="https://streetcomplete.app/">StreetComplete</a></li>
     <p>Um aplicativo de contribuição para o OSM, que permite aos usuários melhorar os dados do mapa de maneira privada e interativa.</p>
    <li><a href="https://www.magicearth.com/">Magic Earth</a></li>
     <p>Magic Earth, navegação curva a curva, OpenStreetMap, Tráfego Colaborativo, mapas 3D, mapas de satélite, mapas offline e Trânsito. Totalmente gratuito.</p>
    <li><a href="https://organicmaps.app/">Organic Maps</a></li>
     <p>Organic Earth é um aplicativo de mapas offline gratuito para Android & iOS para viajantes, turistas, caminhantes e ciclistas baseado em dados OpenStreetMap colaborativos.</p>
    <li><a href="https://osmand.net/">OsmAnd</a></li>
     <p>OsmAnd é um aplicativo de mapas e navegação para Android e iOS. Usa o OpenStreetMap</p>
  </ul>
  <br></br>
   <table>
    <tr>
    <td>Aplicativos de Mensagens</td>
    </tr>
  </table>
  <ul>
    <li><a href="https://github.com/qTox/qTox/blob/master/README.md#qtox">qTox</a></li>
     <p>Com o surgimento dos programas de monitoramento governamental, o qTox fornece um aplicativo fácil de usar que permite que você se conecte com amigos e familiares sem que ninguém mais ouça. Enquanto outros serviços de grande nome exigem que você pague pelos recursos, o qTox é totalmente gratuito e vem sem publicidade.</p>
    <li><a href="https://github.com/evilcorpltd/aTox">aTox</a></li>
     <p>Usa o mesmo protocolo Tox, disponível para o Android</p>
    <li><a href="https://github.com/ricochet-im/ricochet/releases/tag/v1.1.4">Ricochet</a></li>
     <p> Utiliza a rede Tor para criar conexões anônimas, sem revelar a identidade ou localização dos usuários.</p>
    <li><a href="https://www.ricochetrefresh.net/">Ricochet Refresh</a></li>
     <p>É uma atualização do Ricochet apoiada pela BLueprint for Free Speech, uma organização não governamental e sem fins lucrativos</p>
    <li><a href="https://usedust.com/">Dust</a></li>
     <p>Mensageiro privado para Android e iOS</p>
     <li><a href="https://www.kontalk.org/">Kontalk</a></li>
     <p> Uma nova forma de comunicação: rede de mensagens mantida pela comunidade, baseado em XMPP e OpenPGP. </p>
    <li><a href="https://silence.im/">Silence</a></li>
     <p>Criptografe suas mensagens SMS e MMS com Silence. Melhore a sua privacidade, pense livremente.</p>
    <li><a href="https://chatsecure.org/">ChatSecure</a></li>
     <p>ChatSecure é um aplicativo de mensagens gratuito e de código aberto que apresenta criptografia OMEMO e criptografia OTR sobre XMPP. </p>
